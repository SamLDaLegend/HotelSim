...
- **State**: save **v23** · summary **v4** · I2 `07d81ab917935a25` · measure golden
  `c0b590c8d85d0d9c` *(both moved at G-057, one cause — `World.contentHash`; the content
  document gained `scenarios.json` and lost `startingCapitalPence` from `economy.json`, and
  NO behaviour, no `World` field, no migration)* · `pnpm verify` is **FOURTEEN** rows — **ALL GREEN** (re-measured 2026-08-25 at

...
- **State**: save **v24** · summary **v4** · I2 `5ec2e730e128d91c` · measure golden
  `ce9bc72375ddd24f` *(**both moved at G-059 and that move IS BEHAVIOUR**: the review scorer changed
  and `reviewOutcomes` is world state. `c967bdb98dac9b0d` / `a57925e09896e3a4` -> the pair above; no
  `World` field, save stays v24, no migration, `World.contentHash` unmoved. Before that, **both moved

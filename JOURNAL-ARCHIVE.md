# JOURNAL — ARCHIVE (bootstrap through M2)

Per-goal history for G-001 to G-021, moved out of `JOURNAL.md` on 2026-08-12 so the live
journal is the milestone in front of us. **Nothing here is edited** (ADR-0008). The lessons
that are still load-bearing live in `JOURNAL.md`'s digest; this is the evidence behind them.

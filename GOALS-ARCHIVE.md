# GOALS — ARCHIVE (M0, M1, M1.5, M2)

Closed milestones, moved out of `GOALS.md` on 2026-08-12 so that the live ledger is the
work in front of us rather than the work behind us. **Nothing here is edited** — these are
the blocks exactly as they were verified and signed off, and ADR-0008 says an artefact
describing the past must not track the present.

M0 signed off 2026-08-07 · M1 2026-08-08 · M2 2026-08-10. The live digest in `GOALS.md`
carries what still matters from them; `JOURNAL-ARCHIVE.md` carries the per-goal history.
